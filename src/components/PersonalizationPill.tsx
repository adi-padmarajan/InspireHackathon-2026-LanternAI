...
const styleConfig: Record<CopingStyle, { label: string; icon: JSX.Element; color: string }> = {
  talking: {
    label: "Talking",
...
export const PersonalizationPill = ({ copingStyle, className = "" }: PersonalizationPillProps) => {
